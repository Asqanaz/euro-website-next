	...
	return (
		<div className="flex flex-col my-20">
			...
			<p>
				...
				non-profit organization according to Armenian law. The headquarters of IERA are based in Yerevan with a
			...
			<p className="mt-10">
				...
				decisions of the Assembly are taken by a simple majority of votes by all members present and are valid
				if more than half of all members of the organization participate in the Assembly.
			</p>
			<ul className="md:ml-8 dashed">
				<li>To confirm the President and Vice-Presidents of the Board and the termination of their powers</li>
				<li>
